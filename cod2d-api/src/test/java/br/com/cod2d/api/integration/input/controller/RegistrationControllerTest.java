...
//import br.com.cod2d.api.input.controller.RegistrationController;
...
//
//
//class RegistrationControllerTest extends IntegrationTestConfig {
//
//    public static final String API_ORGANIZATION = RegistrationController.PATH;
//
...
//        this.mockMvc.perform(MockMvcRequestBuilders.get(API_ORGANIZATION)
...
//        this.mockMvc.perform(MockMvcRequestBuilders.post(API_ORGANIZATION)
//                        .accept(MediaType.APPLICATION_JSON)
